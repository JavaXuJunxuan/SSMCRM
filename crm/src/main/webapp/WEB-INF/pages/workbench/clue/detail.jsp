...
<script type="text/javascript">
	...
	$(function(){
			...
			$.ajax({
				...
				success:function (data){
					if (data.code == "1"){
						$("#remark").val("");
						var html = "";
						html += "<div class=\"remarkDiv\" id=\"div_data.rtn.id\" style=\"height: 60px;\">"
						html += 	"<img title=\"${sessionScope.sessionUser.name}\" src=\"image/user-thumbnail.png\" style=\"width: 30px; height:30px;\">"
						html += 	"<div style=\"position: relative; top: -40px; left: 40px;\" >"
						html += 		"<h5>"+data.rtn.noteContent+"</h5>"
						html += 		"<font color=\"gray\">线索</font> <font color=\"gray\">-</font> <b>${clue.fullname}${clue.appellation}-${clue.company}</b> <small style=\"color: gray;\">"+data.rtn.createTime+"由${sessionScope.sessionUser.name}创建</small>"
						html += 		"<div style=\"position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;\">"
						html += 			"<a class=\"myHref\" name=\"editA\" remarkId=\""+data.rtn.id+"\" href=\"javascript:void(0);\"><span class=\"glyphicon glyphicon-edit\" style=\"font-size: 20px; color: #E6E6E6;\"></span></a>"
						html += 			"&nbsp;&nbsp;&nbsp;&nbsp;"
						html += 			"<a class=\"myHref\" name=\"deleteA\" remarkId=\""+data.rtn.id+"\" href=\"javascript:void(0);\"><span class=\"glyphicon glyphicon-remove\" style=\"font-size: 20px; color: #E6E6E6;\"></span></a>"
						html += 		"</div>"
						html += 	"</div>"
						html += "</div>"
			...
			$.ajax({
				...
				success:function (data) {
					if(data.code=="1"){
						...
						//刷新已经关联过的市场活动列表
						var htmlStr = "";
						$.each(data.rtn,function (index,obj) {
		...
		$("#checkAll").click(function (){
			var checkIds = $("#tBody input[type='checkbox']");
			$(checkIds).prop("checked",this.checked);
		})
		//转换按钮进行转换页面跳转
